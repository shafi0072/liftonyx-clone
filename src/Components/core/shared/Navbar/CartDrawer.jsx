...
export const CartDrawer = () => {
  ...
  const list = (anchor) => (
      <Box
        ...
        onClick={toggleDrawer(anchor, false)}
        onKeyDown={toggleDrawer(anchor, false)}
        className="overflow-y-auto w-[80%] md:w-[600px] lg:w-[600px]"
      >
        <List>
          ...
          {cartItem.length === 0 ? (
            <ListItem>
              <div className="my-40 text-center items-center justify-center mx-auto">
                <p className="flex text-center items-center mx-32 ">
                  Your cart is empty.
                </p>
                <button className="btn btn-wide text-white bg-black mx-20 my-4">
                  START SHOPPING
                </button>
              </div>
            </ListItem>
                    ...
                    <div className="flex gap-8">
                      <div>
                        ...
                        <div className=" flex items-center justify-center gap-5">
                          <div className="max-w-sm mx-auto mt-5">
                            <div className="flex justify-center px-3 rounded-lg  items-center space-x-5 border border-black  ">
                              <button
                                type="button"
                                onClick={decrement}
                                className="w-2   text-gray-800 font-bold  rounded"
                              >
                                -
                              </button>
                          ...
                          <div className="btn-ghost underline mt-3 ">
                            Remove
                          </div>
                        </div>
                      </div>
